...
import carla
from macad_gym.carla.PythonAPI.agents.navigation.controller import VehiclePIDController
from macad_gym.carla.PythonAPI.agents.tools.misc import draw_waypoints, get_speed
...
class LocalPlanner(object):
    ...
    def _compute_next_waypoints(self, k=1):
        ...
        for _ in range(k):
            ...
            next_waypoints = list(last_waypoint.next(self._sampling_radius)) #_sampling_radius：distance to cur waypoint, return waypoints nearby in this distance
