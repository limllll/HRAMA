...
from models import register_carla_imitation_model_continous
...
model_name = "carla_imitation_model_continuous"
register_carla_imitation_model_continous()
...
def default_policy():
    ...
    return (DDPGTFPolicy,
            ...
            # Discrete(9),
            Box(-1.0, 1.0, shape=(2,)),#Box(low=np.zeros((2, )), high=np.ones((2, ))), #steer, throttle
            config)
...
checkpoint_path="/home/lim/ray_results/Tjunction_ppo_noLSTM_advr3_Nov11/PPO_Town03I3C2_measure_continuous-v0_0_2024-11-11_15-14-23isxfqv9a/checkpoint_150/checkpoint-150"

ray.init(num_cpus=8,memory=20*1024*1024*1024)

analysis = tune.run(
    "DDPG",
    name="Tjunction_ddpg_noLSTM_advr3_Nov12",
    stop={
