...
checkpoint_path="/home/tianshuo/ray_results/Intersection_dqn_noLSTM_madarl_Nov19/DQN_Town03I4C2B1P4-v0_0_2024-11-19_22-29-13apn6pkxn/checkpoint_200/checkpoint-200"
ray.init(num_cpus=8,memory=20*1024*1024*1024)

analysis = tune.run(
    "DQN",
    name="Intersection_dqn_noLSTM_madarl_Dec5",
    stop={
