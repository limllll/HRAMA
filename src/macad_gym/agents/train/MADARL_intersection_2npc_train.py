...
checkpoint_path="/home/tianshuo/ray_results/MADARL-intersection-2NPC-retrain/PPO_MADARLINTE2NPCTown03-v0_0_2024-09-28_16-27-10h4qg8igr/checkpoint_350/checkpoint-350"

# ray.init(num_cpus=30,memory=60*1024*1024*1024)

analysis = tune.run(
    "PPO",
    name="MADARL-intersection-2NPC-retrain",
    stop={
