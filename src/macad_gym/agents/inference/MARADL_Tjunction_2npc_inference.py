...
def env_creator(env_config):
    import macad_gym
    env = gym.make("MADARL2carTown03-v0")
...
checkpoint_path="/home/tianshuo/ray_results/MADARL-tjunction-2NPC/PPO_MADARL2carTown03-v0_0_2024-08-24_12-35-465pz1gb1o/checkpoint_500/checkpoint-500"
...
for v in velocity:
    ...
    with open('MAR_ARL-TJUNCTION-2NPC(checkpoint-500).csv', 'a', newline='') as file:
