...
def env_creator(env_config):
    import macad_gym
    env = gym.make("Town03I4C2B1P4-v0")
...
# checkpoint_path="/home/tianshuo/ray_results/exp2.5_imitation_run/PPO_Town03I3C2_measure_continuous-v0_0_2023-11-30_17-23-42lx402gw9/checkpoint_7000/checkpoint-7000"
# ray.init(num_cpus=30,memory=60*1024*1024*1024)
checkpoint_path="/home/tianshuo/ray_results/Intersection_ppo_LSTM_advr5_Dec14/PPO_Town03I4C2B1P4-v0_0_2024-12-14_01-50-57epnksmqt/checkpoint_2125/checkpoint-2125"
# checkpoint_path="/home/tianshuo/ray_results/Intersection_ppo_LSTM64_advr4_Dec1/PPO_Town03I4C2B1P4-v0_0_2024-12-01_20-30-41dxn6y268/checkpoint_1275/checkpoint-1275"
...
for v in velocity:
    ...
    with open('inference_Intersection_ppo_LSTM_advr5_Dec14.csv', 'a', newline='') as file:
