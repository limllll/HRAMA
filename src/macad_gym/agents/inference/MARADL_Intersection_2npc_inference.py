...
parser.add_argument(
    "--env",
    default="MADARLINTE2NPCTown03-v0",
...
env_name = 'MADARLINTE2NPCTown03-v0'
...
def env_creator(env_config):
    import macad_gym
    env = gym.make("MADARLINTE2NPCTown03-v0")
...
def default_policy():
    ...
    return (PPOTFPolicy,
            Tuple(
                [
                    Box(-1.0, 1.0, shape=(env._y_res, env._x_res, 3)),  # image feature
...
checkpoint_path="/home/tianshuo/ray_results/MADARL-intersection-2NPC-retrain/PPO_MADARLINTE2NPCTown03-v0_0_2024-09-28_23-28-53qx3n1z5b/checkpoint_1000/checkpoint-1000"
...
for v in velocity:
    ...
    # with open('MAR_ARL-INTE-2NPC-RETRAIN(checkpoint-1000).csv', 'a', newline='') as file:
